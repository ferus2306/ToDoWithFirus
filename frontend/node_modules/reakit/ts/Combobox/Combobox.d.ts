...
export declare type unstable_ComboboxOptions = CompositeOptions & Pick<Partial<unstable_ComboboxStateReturn>, "currentValue" | "menuRole" | "list" | "inline" | "autoSelect" | "visible" | "show" | "hide" | "unstable_referenceRef"> & Pick<unstable_ComboboxStateReturn, "baseId" | "inputValue" | "setInputValue"> & {
    /**
     * When enabled, user can hide the combobox popover by pressing
     * <kbd>Esc</kbd> while focusing on the combobox input.
     * @default true
